...
exit;
  ...
  // -------------------------------------------------------
  // [ADDED] Handle ADD / EDIT / DELETE Inventory
  // -------------------------------------------------------
  $inv_form_error = null;
        ...
        <div class="main-content">
          <div class="content-wrapper">
            ...
            <section id="inventorySection" style="display:none;">
              <!-- [CHANGED] replaced <a href="create-form.php"> with modal button -->
              <button class="nav-button" style="align-self:flex-start;" onclick="openModal('addInventoryModal')">+ Add Product</button>
                    ...
                    <?php if ($inventory_array['success']): ?>
                      <?php foreach ($inventory_array['data'] as $row): ?>
                        <tr>
                          ...
                          <td>
                            <!-- [CHANGED] replaced <a href> links with modal buttons -->
            ...
            <section id="ordersSection" style="display:none;">
             ...
             <section id="mplSection" style="display:none;">
              <!-- [CHANGED] replaced <a href="create-form.php"> with modal button -->
              <button class="nav-button" style="align-self:flex-start;" onclick="openModal('addMplModal')">+ Add MPL</button>
...
<!--  SKU MANAGEMENT  -->
    ...
    <script>
      ...
      // -------------------------------------------------------
      // [ADDED] Edit Inventory — pre-fill modal fields
      // -------------------------------------------------------
      ...
      // -------------------------------------------------------
      // [ADDED] Delete Inventory — confirm then submit hidden form
      // -------------------------------------------------------
      ...
      // [ADDED] Toast triggers for inventory and MPL actions
